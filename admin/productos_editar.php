    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" enctype="multipart/form-data" action="productos_editar.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <img src="<?php echo $resultado['imagen_de_producto']?>" style="max-width: 180px;margin-top: 15px;" alt="">
                        </div>
                      </div>
        ...
        if (isset($_POST['producto'])) {
            include_once 'inc/producto/helper.php';
            $ruta = subirImagen();
            ...
            $con->exec($sql);
            ?><script>
                window.location.href = 'producto_listar.php';
            </script> <?php
        }
